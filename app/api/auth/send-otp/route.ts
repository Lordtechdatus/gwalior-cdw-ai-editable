import { checkOtpRequestRate, clientIp, noStoreJson, normalizeIndianMobile, saveOtp, type CdwRole } from "../../../auth/server";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return noStoreJson({ error: "Unable to send OTP right now." }, { status: 503 });
  }
}
